// Jargon Generator stuff goes here from u/SteveTenants
...
module.exports = {
  ...
  execute(bot, channel, args, from, to) {
    ...
    let jargonType = text.includes('tech') ? 'technical'
                    ...
                    : 'excuse'
    if (jargonType != 'excuse' && jargonType != 'technical' && jargonType != 'audio' ) {return bot.say(channel, "I'm supposed to be writing the nonsense here... Wanna try that again?");}
    ...
    return bot.say(channel, sentence);
